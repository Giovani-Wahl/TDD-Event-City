...
import com.devsuperior.demo.services.exceptions.ForbidenException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> methodArgumentNotValid(MethodArgumentNotValidException e,
        ...
        ValidationError error = new ValidationError(Instant.now(),httpStatus.value(),
                "invalid field !",request.getRequestURI());
